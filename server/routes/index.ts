...
import { permissionGate } from "../middlewares/permissions.js";
...
apiRoutes.use("/fornecedores", fornecedoresRoutes);
...
apiRoutes.use("/multas", multasRoutes);
...
apiRoutes.use("/sefaz", sefazDfeRoutes);
